...
def run_job(net_path, x_ls, net_dic_pro1, net_dic_mir1):
    ...
    for x in x_ls:
        ...
        if not os.path.isdir('{}/rewire_full_array/ran_map-{}'.format(net_path, x)):
            os.makedirs('{}/rewire_full_array/ran_map-{}'.format(net_path, x))

        outfile = open('{}/rewire_full_array/ran_map-{}/ran_map-{}.txt'.format(net_path, x, x), 'w')
...
if __name__ == "__main__":
    ...
    net_dic_pro1, net_dic_mir1 = load_dic(args.network)
    ...
    if not os.path.isdir(net_path+'/rewire_full_array'):

        os.mkdir(net_path+'/rewire_full_array')
