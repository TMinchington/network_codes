...
def update_map_dic(line, map_dic, reg_nom_dex, reg_type_dex, targ_nom_dex, targ_type_dex):

    if line[reg_nom_dex] in map_dic[line[reg_type_dex]]:

        if line[targ_nom_dex] not in map_dic[line[reg_type_dex]][line[reg_nom_dex]][line[targ_type_dex]]:

            map_dic[line[reg_type_dex]][line[reg_nom_dex]][line[targ_type_dex]][line[targ_nom_dex]] = 0

    else:

        map_dic[line[reg_type_dex]][line[reg_nom_dex]] = {'protein_coding': {}, 'miRNA':{}}
        map_dic[line[reg_type_dex]][line[reg_nom_dex]][line[targ_type_dex]][line[targ_nom_dex]]=0
...
def read_map_and_fb(map_file):
    ...
    for line in o_map:
        ...
        if first_line:
            ...
            reg_dex, reg_nom_dex, reg_type_dex, targ_dex, targ_nom_dex, targ_type_dex = line.index('regulator'), line.index('regulator_name'), line.index('reg_type'), line.index('target'), line.index('target_name'), line.index('target_type')

            first_line = False
            print(reg_dex, reg_nom_dex, reg_type_dex, targ_dex, targ_nom_dex, targ_type_dex)
            continue
        ...
        elif line[reg_nom_dex] == line[targ_nom_dex] and line[reg_type_dex] == 'protein_coding':

            fb_pro[(line[reg_nom_dex], line[reg_type_dex])] = 0
            map_dic = update_map_dic(line, map_dic, reg_nom_dex, reg_type_dex, targ_nom_dex, targ_type_dex)

        elif line[reg_nom_dex] == line[targ_nom_dex] and line[reg_type_dex] == 'miRNA':

            fb_mir[(line[reg_nom_dex], line[reg_type_dex])] = 0
            map_dic = update_map_dic(line, map_dic, reg_nom_dex, reg_type_dex, targ_nom_dex, targ_type_dex)
