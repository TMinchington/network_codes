...
if len(argv) < 3:
    ...
    print('\nIncorrect number of arguments entered.\n\nUsage:\tpython microME_plus.py species ensembl_structure_file (optional: miRNase_build_no. default=CURRENT)\n')
...
ensembl = pd.DataFrame(pd.read_csv(argv[2], sep='\t', header=0, dtype={'Gene start (bp)':'int', 'Gene end (bp)':'int'}))
